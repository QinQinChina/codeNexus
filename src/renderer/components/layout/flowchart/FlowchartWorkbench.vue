...
function showInvalidConnectionNode() {
  showToast({ kind: "warn", title: t("flowchart.cannotConnectTitle"), message: t("flowchart.cannotConnectNode") });
}
...
function handleConnectionToolNodeClick(nodeId: string) {
  ...
  if (nodeId === tool.sourceId) {
    showToast({ kind: "warn", title: t("flowchart.cannotConnectTitle"), message: t("flowchart.cannotConnectSelf") });
    return true;
  }
