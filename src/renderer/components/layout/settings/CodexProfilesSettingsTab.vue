        ...
        <div class="global-config-section">
          <div class="codex-form-title-row">
            <div>
              ...
              <div class="codex-form-subtitle mono" :title="profilesStore.path">{{ profilesStore.path || "userData" }}</div>
            </div>
...
.codex-profiles-copy h2 {
  margin: 0;
  font-size: 18px;
  line-height: 1.25;
}

.codex-profiles-copy p {
  margin: 0;
