...
export type ClientRequest =
  ...
  | { method: "fs/createDirectory"; id: RequestId; params: FsCreateDirectoryParams }
  ...
  | { method: "mcpServer/resource/read"; id: RequestId; params: McpResourceReadParams }
  | { method: "mcpServer/tool/call"; id: RequestId; params: McpServerToolCallParams }
  ...
  | { method: "process/writeStdin"; id: RequestId; params: ProcessWriteStdinParams }
  ...
  | { method: "fuzzyFileSearch/sessionStart"; id: RequestId; params: FuzzyFileSearchSessionStartParams }
  | { method: "fuzzyFileSearch/sessionUpdate"; id: RequestId; params: FuzzyFileSearchSessionUpdateParams }
  | { method: "fuzzyFileSearch/sessionStop"; id: RequestId; params: FuzzyFileSearchSessionStopParams };
